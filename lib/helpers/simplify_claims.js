...
const simplifyClaim = function (claim, ...options) {
  ...
  const { keepQualifiers, keepReferences, keepIds, keepHashes, keepTypes, keepSnaktypes } = options
  ...
  if (!(keepQualifiers || keepReferences || keepIds || keepTypes || keepSnaktypes)) return value
