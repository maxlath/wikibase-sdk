...
export declare const datatypes: ("string" | "time" | "entity-schema" | "mediainfo" | "commonsMedia" | "edtf" | "external-id" | "geo-shape" | "globe-coordinate" | "localMedia" | "math" | "monolingualtext" | "musical-notation" | "quantity" | "tabular-data" | "url" | "wikibase-form" | "wikibase-item" | "wikibase-lexeme" | "wikibase-property" | "wikibase-sense")[];
export {};
