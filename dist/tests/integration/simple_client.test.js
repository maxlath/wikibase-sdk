...
describe('simpleClient', function () {
    ...
    describe('getEntities', () => {
        it('fetches entities in batches and returns merged simplified entities', async () => {
            const ids = ['Q135519449', 'Q135519450', 'Q135519451'];
...
describe('simpleClient with simplifyEntityOptions', function () {
    ...
    describe('simplifyEntityOptions', () => {
        it('passes keepQualifiers option through to simplifyEntities', async () => {
            ...
            if (!entityWithout || !('claims' in entityWithout) || !entityWith || !('claims' in entityWith))
                return;
            ...
            const firstPropertyWith = Object.values(claimsWith)[0];
            ...
            const firstPropertyWithout = Object.values(claimsWithout)[0];
...
//# sourceMappingURL=simple_client.test.js.map