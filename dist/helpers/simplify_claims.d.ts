...
export declare function simplifyQualifiers(qualifiers: Qualifiers, options?: SimplifySnaksOptions): {};
...
export declare function simplifyReferenceRecord(refRecord: any, options: any): {};
